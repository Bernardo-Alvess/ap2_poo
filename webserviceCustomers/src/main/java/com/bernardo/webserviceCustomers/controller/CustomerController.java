package com.bernardo.webserviceCustomers.controller;
import com.bernardo.webserviceCustomers.model.Customer;
import com.bernardo.webserviceCustomers.services.CustomerService;
...
public class CustomerController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity updateClientById(@PathVariable int id, @RequestBody Customer customer){
